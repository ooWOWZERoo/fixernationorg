    ...
    const pathways = [
      {
        data: {
          ...
          focusAreaIds: [fa["Career & Professional Growth"]].filter(Boolean),
          estimatedDays: 56,
          active: true,
        },
        stages: [
          { title: "Know where you're going", description: "Define your career goals and what success looks like for you.", order: 1 },
          { title: "Build your story", description: "Craft your professional narrative — resume, LinkedIn, and elevator pitch.", order: 2 },
          { title: "Expand your network", description: "Identify 10 people to reach out to and start real conversations.", order: 3 },
          { title: "Apply with intention", description: "Target the right roles, customize your outreach, and track your pipeline.", order: 4 },
          { title: "Prepare and show up", description: "Interview prep, offer negotiation, and making the most of day one.", order: 5 },
        ],
      },
      {
        data: {
        ...
        stages: [
          { title: "See where you stand", description: "Get a clear picture of your income, expenses, and net worth.", order: 1 },
          { title: "Build a budget that fits", description: "Create a realistic spending plan you can actually follow.", order: 2 },
          { title: "Attack your debt", description: "Choose a debt payoff strategy and start making real progress.", order: 3 },
          { title: "Start saving consistently", description: "Set up an emergency fund and automate your savings.", order: 4 },
          { title: "Make your money grow", description: "Introduction to investing and building long-term wealth.", order: 5 },
        ],
      },
      {
        data: {
          ...
          focusAreaIds: [fa["Health & Fitness"]].filter(Boolean),
          estimatedDays: 42,
          active: true,
        },
        stages: [
          { title: "Start with movement", description: "Find a form of movement you enjoy and build a simple routine around it.", order: 1 },
          { title: "Eat with intention", description: "Understand your eating patterns and make one meaningful change.", order: 2 },
          { title: "Fix your sleep", description: "Build a consistent sleep schedule and eliminate the habits disrupting your rest.", order: 3 },
          { title: "Manage your stress", description: "Identify your main stress triggers and build a practical response toolkit.", order: 4 },
          { title: "Make it last", description: "Review your progress and lock in the habits worth keeping for good.", order: 5 },
        ],
      },
    ]
