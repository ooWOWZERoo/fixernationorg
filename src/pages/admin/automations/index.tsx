...
const JOURNEY_TEMPLATES = [
  ...
  // Book-gift redemption (real: /api/redeem.ts, ROLE_CHANGE + source=GIFT_CODE)
  {
    id: "book_gift_redeemed",
    name: "Book gift membership redeemed",
    trigger: "ROLE_CHANGE",
    stepCount: 3,
    cat: "books",
    description: "Thank a reader for redeeming their book's free 90-day membership, then ask for feedback a week later.",
  },
  {
    id: "book_related_recommendation",
    name: "Related book recommendation",
    trigger: "MANUAL",
    stepCount: 1,
    cat: "books",
    description: "Suggest another Fixer Nation book to a past redeemer.",
  },
  {
    id: "book_new_release_announcement",
