...
const AdminBlogEdit: NextPageWithLayout<Props> = ({ post }) => {
  ...
  const [form, setForm] = useState({
    ...
    publishedAt: toDatetimeLocal(post.publishedAt as unknown as string | null),
  });
...
AdminBlogEdit.getLayout = (page) => <AdminLayout>{page}</AdminLayout>;
