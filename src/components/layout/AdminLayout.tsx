...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/tune-your-brain/content", label: "Brain Builder" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/book-orders", label: "Book orders" },
    ],
  },
  {
    label: "CRM",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/issue-topics", label: "Issue topics" },
    ],
  },
  {
    label: "System",
    items: [
      { href: "/admin/team", label: "Invite admin" },
